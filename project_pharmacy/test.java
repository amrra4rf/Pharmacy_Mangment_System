...
public class test extends Application {
    ...
    private void doctor_show_stage() {
        ...
        root.getChildren().addAll(Person.l);
        doctor_show.show();
    ...
    private void user_find_stage() {
      ...
      root.getChildren().addAll(Person.l);           //stoped here
    ...
    private void item_show_stage(){
        ...
        root.getChildren().addAll(Person.m,sort);
        Person.m.setEditable(false);
        stage.setScene(scene);
        Pane pane = new Pane();
    ...
    private void ship_order(){
        Stage stage = new Stage();
         ...
         if(phar.orders_count_in_pharamcy==0)Order.t.appendText("Nor orders yet");
    ...
    public void start(Stage stage) {
        ...
        Image icon = new Image("file:C:/users/moham/onedrive/desktop/icon.jpg");
        Image bg = new Image("file:C:/users/moham/onedrive/desktop/bg.png");
        Image male_icon = new Image("file:C:/users/moham/onedrive/desktop/me.png");
        Image female_icon = new Image("file:C:/users/moham/onedrive/desktop/female.png");
        ...
        Image bg2 = new Image("file:C:/users/moham/onedrive/desktop/bgg2.jpg");
       ...
       show_item.setOnAction(e->{
        ...
        Image cartt = new Image("file:C:/users/moham/onedrive/desktop/cart.png");
...
cb.getItems().add("Doctor: "+name_field.getText());
                         ...
                         phar.person[persons_count_in_pharamcy++] = new Doctor(name_field.getText(), Integer.parseInt(age_field.getText()), Double.parseDouble(salary_field.getText()), pass_field.getText());
                    phar.index = persons_count_in_pharamcy-1;
        ...
        char ge = select.getText().charAt(0);
                              ...
                              phar.person[persons_count_in_pharamcy++] = new Customer(customer_name_field.getText(), Integer.parseInt(customer_age_field.getText()), ge,                    Double.parseDouble(customer_balance_field.getText()),customer_pass_field.getText());
                    phar.index=persons_count_in_pharamcy-1;
